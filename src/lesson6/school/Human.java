...
public interface Human {
    ...
    // c джавы 9 можно определять private методы в интерфейсе
    default void sayHi(){
...
class FirstYearPupil implements Pupil, Human{
  // класс, который реализует - реализует все его методы
    ...
    //  в случае, если в 2-х интерфейсах есть 2 реализации одного метода, у компилятора возникает проблема
    // необходимо переорпеделить метод
    String name;
